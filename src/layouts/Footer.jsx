...
const Footer = () => {
  return (
    <div className='bg-black px-6 py-12 flex flex-col gap-7 text-xl font-medium lg:flex-row lg:p-24 lg:justify-between'>
        <div className='flex flex-col gap-4'>
          <Logo color='white' />
          <p className='text-color-gray'>O maior clube de Futebol 7 da PUCRS</p>
        </div>
        <div className='flex flex-col gap-2'>
          <p className='text-white'>Faça parte</p>
        ...
        <div className='flex flex-col gap-2'>
          <p className='text-white'>Seja PRO</p>
        ...
        <div className='flex flex-col gap-2'>
          <p className='text-white'>Imprensa</p>
